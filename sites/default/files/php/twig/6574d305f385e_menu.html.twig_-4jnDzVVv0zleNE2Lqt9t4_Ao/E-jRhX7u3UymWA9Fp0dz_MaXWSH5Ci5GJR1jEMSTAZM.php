...
/* themes/custom/foobartheme/templates/navigation/menu.html.twig */
class __TwigTemplate_076908c4cfaa1c7348f99ec9d9ea12f6 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    ...
                    echo " class=\"foobartheme-nav__list\">
    ";
                } else {
                    // line 35
                    echo "      <ul>
  ...
  ";
    ...
    {
        return "themes/custom/foobartheme/templates/navigation/menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes }} class=\"foobartheme-nav__list\">
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/foobartheme/templates/navigation/menu.html.twig", "C:\\xampp\\htdocs\\foobar\\themes\\custom\\foobartheme\\templates\\navigation\\menu.html.twig");
    }
